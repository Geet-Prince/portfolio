      ...
      <Section id="skills" className="py-24">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div
            ...
            className="flex flex-wrap items-center justify-center gap-2 mb-8 p-1 bg-(--card)/50 border border-(--border-subtle) backdrop-blur-md rounded-2xl w-fit mx-auto shadow-sm"
          >
            {tabs.map((tab) => (
              <button
                key={tab.id}
